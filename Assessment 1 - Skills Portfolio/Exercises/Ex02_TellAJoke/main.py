...
def showJoke():
    ...
    showPunchLineButton.place(x=400, y=300, anchor=CENTER)
...
tellAJokeButton = Button(main, text="Alexa, tell me a joke", font=("Arial", 12), background="pink", command=lambda:showJoke())
tellAJokeButton.place(x=300, y=300, anchor=CENTER)

showPunchLineButton = Button(main, text="Show punchline", font=("Arial", 12), background="lightgreen", command=lambda:showPunchline())
...
punchlineLabel = Label(main, text="", font=("Arial", 20), background="lightgreen")
